...
// Necesitamos decirle a la textura que se repita
...
const graveMaterial = new THREE.MeshStandardMaterial({color:'#b2b4b1'})
...
// Fog
// near - a que distancia de la camera comienza la niebla
// far a que distancia de la camera se vuelve opaco
